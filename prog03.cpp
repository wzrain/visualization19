...
int main(int, char *[])
{
	...
	reader->SetFileName("D:\\files\\ETH\\19fall\\visualization\\exercise\\prog03_volren\\Teddy_128_128_62.mhd");
	reader->Update();
	...
	// TODO: create a isosurface vtkMarchingCubes object
	vtkSmartPointer<vtkMarchingCubes> isosurface = vtkSmartPointer<vtkMarchingCubes>::New();
	// TODO: assign the volume data (volumeData) as input 
	isosurface->SetInputData(volumeData);
	// TODO: set initial contour value to 40. 
	isosurface->SetValue(0, 40);


	// apply a vtkPolyDataMapper to the output of marching cubes
	// TODO: create a poly data mapper object
	vtkSmartPointer<vtkPolyDataMapper> mapper = vtkSmartPointer<vtkPolyDataMapper>::New();
	// TODO: set the input connection of the mapper to be the output of the isosurface object
	mapper->SetInputConnection(isosurface->GetOutputPort());
	// TODO: set scalar visibility off
	mapper->ScalarVisibilityOff();


	// create a vtkActor and assign the mapper
	vtkSmartPointer<vtkActor> actor = vtkSmartPointer<vtkActor>::New();
	// TODO: assign our mapper to the actor
	...
	callback->MarchingCubes = isosurface;
	...
	// TODO: create an openGL volume render cast mapper 
	vtkSmartPointer<vtkOpenGLGPUVolumeRayCastMapper> castMapper = vtkSmartPointer<vtkOpenGLGPUVolumeRayCastMapper>::New();
	// TODO: assign the volume data (volumeData) as input
	castMapper->SetInputData(volumeData);
	...
	// TODO: create a vtkVolume object (call it volume!)
